...
This theme is a fork of a fork (not a port) of "Terminal" Hugo theme
...
This based on the Kanagawa theme for neovim:
...
# One of: blue, green, orange, red.
# Defaults to blue.
# Or append -auto, e.g. blue-auto
accent_color = "green"

# I have not yet added lotus as the light theme, change at your own risk.
...
- Now in with Kanagawa wave theme
